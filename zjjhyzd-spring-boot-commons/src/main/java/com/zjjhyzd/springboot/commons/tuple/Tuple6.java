...
public final class Tuple6<T0, T1, T2, T3, T4, T5> extends AbstractList<Object> {
	...
	public <T> Tuple7<T0, T1, T2, T3, T4, T5, T> and(T t) {
		return new Tuple7<>(_0, _1, _2, _3, _4, _5, t);
	}
