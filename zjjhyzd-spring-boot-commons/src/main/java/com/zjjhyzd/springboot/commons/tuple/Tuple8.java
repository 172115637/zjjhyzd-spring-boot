...
public final class Tuple8<T0, T1, T2, T3, T4, T5, T6, T7> extends AbstractList<Object> {
	...
	public <T> Tuple9<T0, T1, T2, T3, T4, T5, T6, T7, T> and(T t) {
		return new Tuple9<>(_0, _1, _2, _3, _4, _5, _6, _7, t);
	}
